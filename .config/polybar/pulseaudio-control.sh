...
VOLUME_ICONS=( "Volume " )  # Volume icons array, from lower volume to higher
MUTED_ICON="Mute "  # Muted volume icon
MUTED_COLOR="%{F#6b6b6b}"  # Color when the audio is muted
DEFAULT_SINK_ICON="Sink "  # The default sink icon if a custom one isn't found
